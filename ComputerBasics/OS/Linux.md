...
<span style="font-size:20px">转义</span>
...
<span style="font-size:22px">Install</span>
...
```shell
echo 'eval "$(/opt/homebrew/bin/brew shellenv)"' >> /Users/srf/.zprofile
```
